 ...
 * @param {*} action actions that update selected_r_groups, selected_mol, and chosen_mol
 * @returns updates states for selected_r_groups, selected_mol, and chosen_mol
 */
