...
render()
{
    return(
        ...
        {"\n"}  - Good lipophilicity (i.e. <a href="https://en.wikipedia.org/wiki/Partition_coefficient#:~:text=The%20distribution%20coefficient%2C%20log%20D%2C%20is%20the%20ratio,log%20P%20for%20non-ionizable%20compounds%20at%20any%20pH">LogD</a> ≥ 1 at neutral pH),
        {"\n"}  - Medium to high permeability ( <a href="https://en.wikipedia.org/wiki/Parallel_artificial_membrane_permeability_assay#:~:text=In%20medicinal%20chemistry%2C%20parallel%20artificial%20membrane%20permeability%20assay,-infused%20artificial%20membrane%20into%20an%20acceptor%20compartment.%20">PAMPA</a>),
        {"\n"}  -  Good metabolic stability (low <a href="https://en.wikipedia.org/wiki/Clearance_(pharmacology)">clearance</a>) in mouse and human, and
        {"\n"}  -  High potency (i.e. <a href="https://www.collaborativedrug.com/cdd-blog/what-is-pic50-2#:~:text=Simply%20stated%2C%20pIC50%20is%20the,is%20a%20pIC50%20of%209">pIC<sub>50</sub></a> ≥ 6).
      </p>
      </div>}
